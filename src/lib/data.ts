...
export const paintingsData: IPaintingsData[] = [
  ...
  },
  {
    ...
    transcription: "Transcription: Et vous là ! Oui vous, regardez-moi, ne suis-je pas sublime ? Mon peintre, Guillaume Alaux, a parfaitement su retranscrire ma beauté ! Ce jour-là, je portais mon ravissant chape… Mais … MON CHAPEAUX A DISPARU ! Et puis, que fait ce vieux truc sur ma figure ! C’est ridicule, je ne suis plus écolière ! Je suis sûre que c’est une affaire de ce prétentieux narcissique Alfred Roll, c’est tout à fait son style ! Visiteur, partez diligemment à sa recherch e, retirez-moi ce testament de la tête, je ne peux pas sortir en cheveux, c’est indécent !",
    missingItemId: 3
  },
  {
