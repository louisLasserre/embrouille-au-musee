...
export const paintingsData: IPaintingsData[] = [
  {
    ...
    transcription: "Transcription Ô rage, ô désespoir ! Le testament de notre défunt père a disparu et a été remplacé par ce vieux foulard ! Que dirait notre créateur Eugène Buland ! À quoi rime désormais notre nom les “Héritiers” !?Oh ! Vous êtes là !? Je vous en supplie ! Enlevez-moi ce foulard et retrouvez notre testament ! C’est sûrement cette… cette… nigaude arrogante à l’ego aussi gros que son chapeau, qui nous l’a dérobé, cette madame Samazeuilh !",
    missingItemId: 2,
    reactionVideos: [
      {
        name: "placedItems",
